...
3D 太阳系模拟器，支持所有八大行星 + 冥王星 + 小行星带 + 土星环。

**功能亮点：**
- 🌟 **完整太阳系** — 太阳（发光脉动）、水星·金星·地球·火星·木星·土星（带光环）·天王星·海王星 + 冥王星
- 🎚️ **全参数可调** — 时间流速、行星大小、各行星独立轨道速度、显示开关（轨道线/名称）
- 🖱️ **交互操作** — 鼠标拖拽旋转视角、滚轮缩放、点击行星查看信息
- 🚀 **零依赖运行** — 单 HTML 文件，打开即用

```bash
# 直接双击 index.html 或：
open toys/solar-system/index.html
```

[完整文档](toys/solar-system/README.md)
